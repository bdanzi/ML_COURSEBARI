...
Original file is located at
    https://colab.research.google.com/drive/1kIi_PvdDUpBEived_nMpcs6lp6rymZVh
"""
...
if EPOCHS < 100:  LOQUACIOUS=0
mlpfitted = cl.fit(x,y,epochs=EPOCHS, batch_size=256, verbose=LOQUACIOUS, validation_split=0.1, callbacks = callback_list)
cl.evaluate(x,y)
print("Training Done")
...
plt.plot(mlpfitted.history['loss'], label='DNN loss train',color='green')
plt.plot(mlpfitted.history['val_loss'], label='DNN loss validation',color='magenta')
...
if EPOCHS < 100:  LOQUACIOUS=0
#mlpfitted_two = cl1.fit(x,y,epochs=EPOCHS, batch_size=128, verbose=LOQUACIOUS, validation_split=0.1, callbacks = callback_list)
#cl1.evaluate(x,y)
print("Training Done")
...
plt.figure()
#plt.plot(score_mp_sig_test,score_bdt_sig_test,"o",color="darkblue",label="Signal Test events")
plt.plot(score_mp_sig_test,score_bdt_sig_test,"o",color="darkorange",lw=lw,label="Signal Test events")
#plt.plot(score_mp_bkg_test,score_bdt_bkg_test,"o",color="darkgreen",label="Bkg Test events")
plt.plot(score_mp_bkg_test,score_bdt_bkg_test,"o",color="purple",lw=lw,label="Bkg Test events")
plt.plot([0, 1], [0, 1], color="navy", lw=lw, linestyle="--")
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel("MLP score")
...
plt.figure()
#plt.plot(score_mp_sig_test,score_bdt_sig_test,"o",color="darkblue",label="Signal Test events")
plt.plot(score_mp_sig_test,score_rf_sig_test,"o",color="darkorange",lw=lw,label="Signal Test events")
#plt.plot(score_mp_bkg_test,score_bdt_bkg_test,"o",color="darkgreen",label="Bkg Test events")
plt.plot(score_mp_bkg_test,score_rf_bkg_test,"o",color="purple",lw=lw,label="Bkg Test events")
plt.plot([0, 1], [0, 1], color="navy", lw=lw, linestyle="--")
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel("MLP score")
...
hist_test_mp_sig = plt.hist(score_mp_sig_test, bins=X, label='test_sig',histtype='step',log=True,density=1)
hist_test_mp_bkg = plt.hist(score_mp_bkg_test, bins=X, label='test_bkg',histtype='step',log=True,density=1)
hist_train_mp_sig = plt.hist(score_mp_sig_train, bins=X, label='train_sig',histtype='step',log=True,density=1)
hist_train_mp_bkg = plt.hist(score_mp_bkg_test, bins=X, label='train_bkg',histtype='step',log=True,density=1)
...
hist_train_bdt_bkg = plt.hist(score_bdt_bkg_test, bins=X, label='train_bkg',histtype='step',log=True,density=1)
...
hist_train_rf_bkg = plt.hist(score_rf_bkg_test, bins=X, label='train_bkg',histtype='step',log=True,density=1)
plt.xlabel('RF score')
plt.ylabel('Frequency')
plt.legend( loc='upper right',prop={'size': 8} )
