...
OOBResults_test = cl.predict(xtst)  ## Get predictions from NN on test data.
...
if EPOCHS < 100:  LOQUACIOUS=1
cl.fit(x,y,epochs=EPOCHS, batch_size=64, verbose=LOQUACIOUS, validation_split=0.3)
cl.evaluate(x,y)
bdt.fit(x,y)
print("Training Done")
